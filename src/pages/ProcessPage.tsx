    ...
    <>
      <section className="pt-32 pb-24 bg-black min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
            ...
            <div className="space-y-8">
              {processSteps.map((step, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="grid md:grid-cols-12 gap-6 items-center group animate-slide-in-left"
          ...
          <div className="bg-gray-900 p-8 md:p-12 rounded-lg border-l-4 border-orange-500 animate-fade-in">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div>
                <p className="text-xl text-white leading-relaxed mb-6 italic">
                  Working with Segullah transformed our go-to-market approach. Their
